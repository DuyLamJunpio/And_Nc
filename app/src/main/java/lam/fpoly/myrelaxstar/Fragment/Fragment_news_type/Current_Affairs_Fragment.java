...
public class Current_Affairs_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_current__affairs_, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Current = view.findViewById(R.id.idRcv_Current);
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Current);
    }
