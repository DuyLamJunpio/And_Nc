...
public class Featured_News_Fragment extends Fragment {
private RecyclerView idRcv_Featured;
private DownLoad_News downLoad_news;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_featured__news_, container, false);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        idRcv_Featured = view.findViewById(R.id.idRcv_Featured);
        String urlRss = "https://vnexpress.net/rss/tin-noi-bat.rss";

        downLoad_news = new DownLoad_News();
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Featured);
    }
