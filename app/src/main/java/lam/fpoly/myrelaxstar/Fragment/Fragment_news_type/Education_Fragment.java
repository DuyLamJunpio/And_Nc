...
public class Education_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_education_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Education = view.findViewById(R.id.idRcv_Education);
        String urlRss = "https://vnexpress.net/rss/giao-duc.rss";
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Education);
    }
