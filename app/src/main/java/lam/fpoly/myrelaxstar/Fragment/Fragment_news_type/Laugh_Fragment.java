...
public class Laugh_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_laugh_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Laugh = view.findViewById(R.id.idRcv_Laugh);
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Laugh);
    }
