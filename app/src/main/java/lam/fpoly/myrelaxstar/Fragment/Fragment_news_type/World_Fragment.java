...
public class World_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_world_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_World = view.findViewById(R.id.idRcv_World);
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_World);
    }
