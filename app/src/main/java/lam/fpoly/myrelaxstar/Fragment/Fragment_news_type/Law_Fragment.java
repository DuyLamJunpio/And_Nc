...
public class Law_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_law_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Law = view.findViewById(R.id.idRcv_Law);
        String urlRss = "https://vnexpress.net/rss/phap-luat.rss";
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Law);
    }
