...
public class Life_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_life_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Life = view.findViewById(R.id.idRcv_Life);
        String urlRss = "https://vnexpress.net/rss/gia-dinh.rss";
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Life);
    }
