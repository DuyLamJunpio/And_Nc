...
public class Travel_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_travel_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Travel = view.findViewById(R.id.idRcv_Travel);
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Travel);
    }
