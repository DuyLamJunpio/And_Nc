...
public class Science_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_science_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Science = view.findViewById(R.id.idRcv_Science);
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Science);
    }
