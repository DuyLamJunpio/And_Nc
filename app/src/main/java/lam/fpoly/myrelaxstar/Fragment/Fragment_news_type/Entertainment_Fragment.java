...
public class Entertainment_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_entertainment_, container, false);
    }
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        RecyclerView idRcv_Entertainment = view.findViewById(R.id.idRcv_Entertainment);
        ...
        downLoad_news.dowLoad(urlRss,getActivity(),idRcv_Entertainment);
    }
