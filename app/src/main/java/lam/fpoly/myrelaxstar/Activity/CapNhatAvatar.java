...
public class CapNhatAvatar extends AppCompatActivity {
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cap_nhat_avatar);
        imageView = Account_Fragment.imgAvtUser;
        openCamera();
        ...
        if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
            ...
            if (photoFile != null) {
                Uri photoURI = FileProvider.getUriForFile(this,
                        "lam.fpoly.myrelaxstar.Activity.CapNhatAvatar",
                        photoFile);
